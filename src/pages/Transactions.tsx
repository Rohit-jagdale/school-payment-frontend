...
const Transactions: React.FC = () => {
  ...
  const [selectedInstitute, setSelectedInstitute] = useState(searchParams.get('institute') || '');
  ...
  const handleInstituteChange = (institute: string) => {
    ...
    if (institute) {
      const newFilters = { ...filters, schoolIds: [institute] };
      setFilters(newFilters);
      updateURLParams(newFilters, sort, pagination);
    }
  };
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <div className="relative">
              <select
                ...
                className="appearance-none px-4 py-2 pr-8 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent min-w-40"
              >
                <option value="">Select Instit</option>
